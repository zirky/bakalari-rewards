// LNbits extension router expects window[r.name] as a Vue Options object.
// Template is loaded via loadTemplate() which appends index.html to body.
// We reference it by id selector instead of using an inline string
// (inline strings require new Function() which SES/Lockdown blocks).
